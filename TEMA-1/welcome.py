...
# Created by Lázaro Alonso, modified by Oscar Jaramillo.
...
def print_words(sentence):
    for word in sentence.split():
        for l in word:
            ...
            print(l, end = '')
        print(end = ' ')
sentence1 = 'Hola, bienvenid@ a la asignatura de Simulación de procesos financieros.'
print_words(sentence1)
sentence2 = 'Soy Oscar Jaramillo y me gustaría saber un poco acerca de ti, por ejemplo'
...
sentence5 = 'Acá aprenderemos cómo usando datos y montecarlo podremos realizar simulaciones de sistemas financieros.'
